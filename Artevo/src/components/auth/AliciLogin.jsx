  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-10 font-inter text-black">
        <h2 className="mb-[15px] text-2xl md:text-3xl font-bold ">Alıcı</h2>
      ...
      <form onSubmit={handleLogin} className="space-y-5">
        ...
        {/* Şifrə İnputu */}
        <AuthInput label="ŞİFRƏ" type="password" placeholder="Şifrə" />
        ...
        <div className="relative flex py-2 items-center text-xs text-gray-400 uppercase font-semibold">
          ...
          <span className="flex-shrink mx-4 text-gray-400 select-none">
            VƏ YA
          </span>
          <div className="flex-grow border-t border-gray-200"></div>
        </div>
        ...
        <AuthButton
          ...
          icon={
            <svg className="w-5 h-5" viewBox="0 0 24 24">
              <path
                fill="#4285F4"
                d="M23.745 12.27c0-.7-.06-1.4-.19-2.07H12v3.92h6.61c-.29 1.53-1.14 2.82-2.4 3.68v3.05h3.88c2.27-2.09 3.65-5.17 3.65-8.78z"
              />
              <path
                fill="#34A853"
              ...
              <path
                fill="#FBBC05"
                d="M5.27 14.24A7.16 7.16 0 0 1 4.91 12c0-.79.13-1.57.36-2.31V6.54H1.21A11.96 11.96 0 0 0 0 12c0 2.01.5 3.91 1.21 5.62l4.06-3.38z"
              />
              <path
                fill="#EA4335"
                d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.42-3.42C17.95 1.19 15.24 0 12 0 7.31 0 3.18 2.12 1.21 5.62l4.06 3.38c.95-2.85 3.6-4.96 6.73-4.96z"
              />
            </svg>
          }
        >
