          ...
          className="flex-1 max-w-[160px] md:max-w-[240px]  h-[30px] sm:h-[46px] md:h-[54px] relative group font-sans">
           <button type="button"
            ...
            <div
                ...
                <a href="#"
                    className="block text-center py-2 md:py-3.5 text-xs md:text-sm text-black bg-white border-b border-gray-100 transition-colors duration-200 hover:bg-gray-100">
                    Satıcı
                 </a>
                 <a href="#"
                     className="block text-center py-2 md:py-3.5 text-xs md:text-sm text-black bg-white transition-colors duration-200 hover:bg-gray-100">
                     Alıcı
                 </a>
             </div>
       </div>
