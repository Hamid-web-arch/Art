...
export default function MostViewed() {
  const productsData = [
    ...
    },
    {
      id: 2,
      badge: "Zərgərlik",
      title: "Gümüş Boyunbağı – Unikal",
      oldPrice: "300 AZN",
      currentPrice: "180 AZN",
      rating: "4.5",
    ...
    },
    {
      id: 4,
      badge: "Toxuma",
      title: "Əl işi nağıl xalça – Naxışlı",
      oldPrice: "510 AZN",
      currentPrice: "370 AZN",
      rating: "4.8",
  ...
  return (
    <section className="container py-[40px] md:py-[86px]">
      ...
      <HamisinaBaxButton path="/most-viewed" />
    </section>
  );
}